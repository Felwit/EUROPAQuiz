...
namespace Europaquiz
{
    ...
    public partial class Europaquiz : Form
    {
        ...
        {
            CountdownAnzeige.Text = countdown.ToString();
        ...
        private void Button_prüfe_Land_neu_Click(object sender, EventArgs e)
        {
            ...
            {
                countdown = 10; //Muss noch eingestellt werden. Je nach Schwierigkeitsgrad
                Timer.Start();
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (CountdownAnzeige.Text == "0")
            {
                ...
                tb_Land.Hide();
                Button_prüfe_Land_neu.Show();
                Button_prüfe_Land_neu.PerformClick();
            }
        }
    }
    }
